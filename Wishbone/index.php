					...
					<div class="header__toogleGroup">
						...
						<div class="search-form">
							<div class="search-form__toggle">
								...
								<div class="search-form__form"></div>					
									<div class="form-search">
										<form>
											<input class="form-control" type="text" placeholder="Enter location to find entertainers"/>
										</form>
									</div>
								</div>
						</div>
...
-->
						...
						<div class="row">
							<div class="col-md-4 col-lg-4 ">
								...
								<div class="textbox">
									<div class="textbox__image">
										<a href="#"><img
											src="C:/Users/nanda/Desktop/Algonquin/wishbone/wishbone pictures/wishbone1.jpg"
											alt="" /></a>
									</div>
									<div class="textbox__body">
										...
										<div class="textbox__description">Organize local talent
											on demand. Social icons will be respected through our rating
											system to offer the finest quality of work. Explore all
											desired services through our discover tab.</div>
									</div>
								</div>
								<!-- End / textbox -->
							...
							<div class="col-md-4 col-lg-4 ">
								...
								<div class="textbox">
									<div class="textbox__image">
										<a href="#"><img
											src="C:/Users/nanda/Desktop/Algonquin/wishbone/wishbone pictures/wishbone2.jpg"
											alt="" /></a>
									</div>
									<div class="textbox__body">
										<h2 class="textbox__title">
										...
										<div class="textbox__description">Network through our
											interconnected system of rated portfolios. Collaborate,
											contact and gain inspiration from similar profiles;
											progressing towards building your own brand.</div>
									</div>
								</div>
								<!-- End / textbox -->
							...
							<div class="col-md-4 col-lg-4 ">
								...
								<div class="textbox">
									<div class="textbox__image">
										<a href="#"><img
											src="C:/Users/nanda/Desktop/Algonquin/wishbone/wishbone pictures/wishbone3.jpg"
											alt="" /></a>
									</div>
									<div class="textbox__body">
										<h2 class="textbox__title">
										...
										<div class="textbox__description">Ensure that your
											services are given the gratitudes they deserve. Charge for
											your services and organize clientele to manage future
											transactions.</div>
									</div>
								</div>
								<!-- End / textbox -->
			...
			<!-- Section -->
			<section class="md-section"
				style="background-color: #f7f7f7; padding-top: 0;">
				<div class="container">
					<div class="row">
						<div
							...
							<div class="iconbox">
								...
								<div>
									<h2 class="iconbox__title">
										<a href="#">Talent Around You</a>
									</h2>
									<div class="iconbox__description">Wishbone is geared
										toward structuring talented entrepreneurs by offering their
										service on demand. Here you will have the leniency of finding
										local talent, booking venues or receiving services from well
										respected locals demonstrating their finest quality of work.
										Innovation, creativity, and exposure are key qualities we
										ensure our talent - giving our community group the needed
										resources to develop their brand. Use your talents and explore
										the amazing opportunities that are presented within our
										Wishbone community.</div>
								</div>
							</div>
							<!-- End / iconbox -->
						...
						<div class="col-sm-6 col-md-6 col-lg-3 ">
							...
							<div class="iconbox iconbox__style-02">
								...
								<div>
									...
									<div class="iconbox__description">Moors skirt sterilized
										carrots cartoon. Integer No animal would. But the makeup
										Reserved football</div>
								</div>
							</div>
							<!-- End / iconbox -->
						...
						<div class="col-sm-6 col-md-6 col-lg-3 ">
							...
							<div class="iconbox iconbox__style-02">
								...
								<div>
									...
									<div class="iconbox__description">In regards to our
										partnership, Wishbone contains a service which provides
										members discounted rates to enhance a clientele base through
										our operated marketing services. Regulate your marketing
										strategies by working with experienced recruits at the touch
										of your fingertips</div>
								</div>
							</div>
							<!-- End / iconbox -->
						...
						<div class="col-sm-6 col-md-6 col-lg-3 ">
							...
							<div class="iconbox iconbox__style-02">
								...
								<div>
									...
									<div class="iconbox__description">Renting spaces has
										never been so easy - members will have discounted rates to
										rent halls, attend wishbone presented events and organize
										future event planning</div>
								</div>
							</div>
							<!-- End / iconbox -->
						...
						<div class="col-sm-6 col-md-6 col-lg-3 ">
							...
							<div class="iconbox iconbox__style-02">
								...
								<div>
									...
									<div class="iconbox__description">Coverage through the
										community helps get your name out there; through Wishbones
										developed partnerships, we have partnered with well respected
										media sources to offer members credible insight and coverage
										based on the content you post. - From blogs, interviews,
										articles, and more, we provide you with inclusive media
										coverage throughout numerous media outlets along your journey
										as an independent entertainer.</div>
								</div>
							</div>
							<!-- End / iconbox -->
					...
					<div class="row">
						<div class="col-lg-6 ">
							...
							<div class="title-01 title-01__style-03 md-text-left">
								...
								<h2 class="title-01__title">Journey to become leaders in
									entertainment</h2>
								<div>As leaders - we are able to guide our lives towards
									an innovative path by creating new forms of passions,
									opportunities and ideas. Wishbone favours the idea of unity as
									a determining factor for the success of any pursued
									organization. Our values lie on creating a platform where we
									will optimize networking amongst diverse groups; making it
									easily accessible to reach different crowds, and build
									relationships that benefit all individuals. Through our rating
									system, we propose that satisfaction will appeal to the
									wishbone community by encouraging our clientele to earn and
									strive for the finest quality of work - making their rating a
									mere reflection of their work.</div>
							</div>
							<!-- End / title-01 -->
								...
								<div class="col-sm-4 ">
									...
									<div class="box-number">
										<div class="box-number__number">
											<h2 class="js-counter" data-counter-time="2000"
												data-counter-delay="10">99</h2>
										</div>
							...
							<div class="js-consult-slider">
								...
								<div class="carousel__element owl-carousel"
									...
									<div class="image-full">
										<img
											src="C:/Users/nanda/Desktop/Algonquin/wishbone/wishbone pictures/wishbone4.jpg"
											alt="">
									</div>
			...
			<section class="md-section md-skin-dark js-consult-form"
				style="background-image: url(&amp;quot;assets/img/backgrounds/1.jpg&amp;quot;);">
				<div class="md-overlay"></div>
				<div class="container">
					<div class="row">
						<div
							class="col-lg-8 offset-0 offset-sm-0 offset-md-0 offset-lg-2 ">

							<!-- title-01 -->
							<div class="title-01 title-01__style-02">
								<h2 class="title-01__title">Contact With Us via Hot Line</h2>
								<div>However, at airports, in ferment and antioxidants,
									the biggest</div>
							</div>
							<!-- End / title-01 -->
						...
						<div class="carousel__element owl-carousel"
							...
							<div class="testimonial">
								<div class="testimonial__info">
									<a class="testimonial__avatar" href="#"><img
										src="assets/img/avatars/avatar-01.jpg" alt="" /></a>
									<h5 class="testimonial__name">Brandon Hanson</h5>
									<span class="testimonial__position">Support</span>
								</div>
								<div class="testimonial__content">
									<div class="testimonial__text">Lorem ipsum dolor sit
										amet, consectetur adipiscing elit. Architex lake and a
										headset. Quisque luctus nibh augue, non ultrices arcu molestie
										in. In</div>
								</div>
							</div>
							<!-- End / testimonial -->
							...
							<div class="testimonial">
								<div class="testimonial__info">
									<a class="testimonial__avatar" href="#"><img
										src="assets/img/avatars/avatar-02.jpg" alt="" /></a>
									<h5 class="testimonial__name">Brandon Hanson</h5>
									<span class="testimonial__position">CEO &amp; Founder</span>
								</div>
								<div class="testimonial__content">
									<div class="testimonial__text">However, at airports, in
										ferment and antioxidants, but the biggest thing. Tomorrow
										Bureau feugiat to ecological boundaries, but now. Each of said
										propaganda, V</div>
								</div>
							</div>
							<!-- End / testimonial -->
							...
							<div class="testimonial">
								<div class="testimonial__info">
									<a class="testimonial__avatar" href="#"><img
										src="assets/img/avatars/1.jpg" alt="" /></a>
									<h5 class="testimonial__name">Maria Gutierrez</h5>
									<span class="testimonial__position">Designer</span>
								</div>
								<div class="testimonial__content">
									<div class="testimonial__text">Moors skirt sterilized
										carrots cartoon. Integer No animal would. But the makeup
										Reserved football arrows weekend. Gluten. praesen</div>
								</div>
							</div>
							<!-- End / testimonial -->
					...
					<div class="carousel__element owl-carousel"
						...
						<div>
							<div class="post-01__media">
								<a href="#"><img src="assets/img/blogs/related-1.jpg" alt="" /></a>
							</div>
							<div>
								...
								<h2 class="post-01__title">
									<a href="#">Getting Started with Vue.Js</a>
								</h2>
						...
						<div>
							<div class="post-01__media">
								<a href="#"><img src="assets/img/blogs/related-2.jpg" alt="" /></a>
							</div>
							<div>
								<ul class="post-01__categories">
									<li><a href="#">Services</a></li>
						...
						<div>
							<div class="post-01__media">
								<a href="#"><img src="assets/img/blogs/related-3.jpg" alt="" /></a>
							</div>
							<div>
								<ul class="post-01__categories">
									<li><a href="#">Services</a></li>
								...
								<h2 class="post-01__title">
									<a href="#">How to Create and Manage SVG Sprites</a>
								</h2>
						...
						<div>
							<div class="post-01__media">
								<a href="#"><img src="assets/img/blogs/related-4.jpg" alt="" /></a>
							</div>
							<div>
								<ul class="post-01__categories">
