...
class Database
{
    ...
    {
        $this->DBH = new PDO(sprintf("mysql:host=%s;port=%d;dbname=%s;charset=%s", Server::getDB_HOST(), $port, Server::getDB_DATABASE(), $charset), Server::getDB_USERNAME(), Server::getDB_PASSWORD());
    }
