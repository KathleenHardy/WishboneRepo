   ...
   <div class="mycontent" style="margin-top: 100px">
			...
			<div class="leftContent">
				<div class="card">
					<div class="pictureBack">
						...
						<img src="wishbone pictures/oksana2.jpg" alt="oksana2"
							class="oksana2" style="width: 100%"> <img
							src=<?php echo "\"".$Login_user_imagelocation."\"" ?>
							alt="oksana" class="oksana" style="width: 70%">
					</div>
			...
			<div class="rightContent">
				<form action="insertPost.php" method="post" width=100px>
					<div class="posts">
						<textarea class="serverText" placeholder="type your post"
							name="dataPost" required></textarea>
						<div class="button">
				...
				<div class="searchFeed" height=50px>
					<form action="searchFeed.php">
						...
						<input class="input" name="input" placeholder="search" height=60px
							width=250px>
						<button class="buttonSearchFeed">
							<img alt="" src="assets/img/search-icon.png" width=20px
								height=20px>
						</button>
					</form>
				</div>
    ...
    ?>
				...
				<div class="bottomFeed"></div>
			</div>
			<div class="feed">

				<img src="wishbone pictures/adver2.jpg" alt="adver2" class="adver2"
					style="width: 85%"> <img src="wishbone pictures/adver1.jpg"
					alt="adver1" class="adver1" style="width: 85%">
