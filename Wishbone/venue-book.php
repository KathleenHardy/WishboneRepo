...
// }
include ('dao/venueBookingDAO.php');
$hasError = false;
...
require_once ("config.php");
 ...
 if ( isset($_POST["venueName"])) {
     $venueBooking = new VenueBooking($_POST["venueName"]);
    
     
     $bookingSuccess = $venueBookingDAO->createNewBooking($venueBooking);
     echo $bookingSuccess;
											...
											<div class="form-search">
												<form
													...
													<input id="venueName" name="venueName" type="text"
														class="form-control"
														placeholder="Please enter the name of the venue you would like to book" required>

													<div class="form__button">
														<button class="btn btn-primary btn-w180" type="submit">Book</button>
													</div>
												</form>
											</div>
											<!-- End / form-search -->
