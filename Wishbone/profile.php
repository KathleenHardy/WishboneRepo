				...
				<div class="container">
					...
					<div class="consult-postDetail__main">
						...
						<div class="row mb-">
							<div class="col-4"></div>
							<div class="col-4">
								<img src="<?php echo $profilelists['imagelocation']?>"
									alt="profile-photo" class="pro-photo" />
							</div>
							<div class="col-4"></div>
						</div>
						...
						<div class="row">
							<div
								...
								<div class="consult-postDetail__content">
									<div class="row">
										<div
											class="col-xl-12 offset-0 offset-sm-0 offset-md-0 offset-lg-0">
												<?php
											...
											<div class="row mb-3">
												<div class="social-01__style-02 margn-center">
													<nav class="social-01__navSocial">
														<a class="social-01__item text-center" href="#"><i
															class="fa fa-facebook"></i></a> <a
															class="social-01__item text-center" href="#"><i
