...
$errorMessages = Array();
$addSuccess = '';
if (isset($_POST["userFirstName"]) || isset($_POST["userLastName"]) || isset($_POST["userEmail"]) || isset($_POST["userPhoneNumber"]) || isset($_POST["role"]) || isset($_POST["bio"]) || isset($_POST["experiencetitle"]) || isset($_POST["experiencetime"])) {
    ...
    if (! $hasError) {
        $updateinfo = array(
            ...
            $_POST["userLastName"],
            $_POST["userEmail"],
            $_POST["userPhoneNumber"],
            $_POST["city"],
            $_POST["role"],
            $_POST["bio"],
            $_POST["url"],
            $_POST["urldes"],
            $_POST["experiencetitle"],
            $_POST["experiencetime"],
            $_POST["experiencedes"]
        );
	...
	<div class="container pt-4 mb-3">
		<div class="mt-5 pt-5 col-6 mx-auto">
			<form action="#" method="POST">
				<span class="logintitle"><h4>Edit your info</h4></span> <span>Please
					enter your FirstName:</span><span class="text-danger">*</span> <input
					class="form-control" name="userFirstName"
					value="<?php echo $profilelists['firstname']?>" required>
				<p>
		                <?php
				...
				<input class="form-control" name="userLastName"
					value="<?php echo $profilelists['lastname']?>" required>
				<p>
		                <?php
				...
				<input class="form-control" name="userEmail"
					value="<?php echo $profilelists['email']?>" required>
				<p>
		                <?php
				...
				<input class="form-control" name="userPhoneNumber"
					value="<?php echo $profilelists['phone']?>" required>
				<p>
		                <?php
				...
				<div>Please select your City and Province:(the default value will be
					Ottawa)</div>
				...
				<div>
					Please enter your definition of yourself:(the default value will be
					musician)/div>
					...
					<input class="form-control" name="bio"
						value="<?php echo $profilelists['bio']?>" required>
					<p>
		                <?php
                ...
                ?>
					...
					<span>Please enter Youtube channel name (optional):</span> <input
						class="form-control" name="url"
						value="<?php echo $profilelists['url']?>"> <span>Please enter your
						channel description (optional):</span>
					...
					<input class="form-control" name="experiencetitle"
						value="<?php echo$profilelists['experience']->getExperienceTitle()?>"
						required>
					<p>
		                <?php
                ...
                ?>
					...
					<span>Please enter your work experience time:</span><span
						class="text-danger">*</span> <input class="form-control"
						name="experiencetime"
						value="<?php echo$profilelists['experience']->getExperienceTime()?>"
						required>
					<p>
		                 <?php
                ...
                ?>
					...
					<div class="text-center">
						...
						<input type="button" class="btn btn-warning"
							onclick="window.location.href='profile.php'" value="Cancel">
					</div>
			...
			<div class="row row-eq-height">
				<div class="col-8 col-sm-7 col-md-9 col-lg-3 ">
					<div class="footer__item" style="top: -12px; position: relative;">
						<a style="font-size: 35px; font-weight: 700;" href="index.php">WISHBONE</a>
