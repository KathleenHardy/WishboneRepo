...
class AuthenticationDAO extends AbstractDAO
{
    ...
    {
        $imageLoc = array(
            'assets/img/profile/M1.jpg',
            'assets/img/profile/M2.jpg',
            'assets/img/profile/M3.jpg',
            'assets/img/profile/M4.jpg',
            'assets/img/profile/M5.jpg',
            'assets/img/profile/M6.jpg',
            'assets/img/profile/M7.jpg',
            'assets/img/profile/M8.jpg',
            'assets/img/profile/M9.jpg',
            'assets/img/profile/F1.jpg',
            'assets/img/profile/F2.jpg',
            'assets/img/profile/F3.jpg',
            'assets/img/profile/F4.jpg',
            'assets/img/profile/F5.jpg',
            'assets/img/profile/F6.jpg'
        );

        if (! $this->mysqli->connect_errno) {
            $query1 = 'INSERT INTO authentication
                            (email, pass, userType) VALUES(?,?,1)';
