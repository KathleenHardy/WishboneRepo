            ...
            <div class="col-md-4 mx-auto">
              <div class="u-pull-half text-center">
                <img class="img-fluid u-avatar u-box-shadow-lg rounded-circle mb-3" width="200" height="auto" src="../assets/img-temp/200x200/img1.jpg" alt="Image Description">
										...
										<h2 class="title2">Scotiabank Concert Hall</h2>
										<h2 class="title2">Location: 1293 Bank St., Ottawa, ON</h2>
										<h2 class="title2">An entertainment venue usually used for rockbanks and concerts for big entertainers. Over 5000 seats.</h2>
										
										
											
										<a href="venueProfileUpdate.php"><button type="button" class="btn-all" style="display:inline;">Update</button></a>
							</div>
							</div>
							</div></div>
			</section>
