...
<br/><p/>
			<div class="fs-form-wrap" id="fs-form-wrap">
				...
				<form id="myform" class="fs-form fs-form-full" autocomplete="off">
					<ol class="fs-fields">
						<li>
							<label class="fs-field-label fs-anim-upper" for="q0" style="font-family:'Archivo', sans-serif; font-size: 25px;">What's your first name?</label>
							<input class="fs-anim-lower" id="q0" name="q0" type="text" placeholder="First name" required/>
						</li>
						<li>
							<label class="fs-field-label fs-anim-upper" for="q1" style="font-family:'Archivo', sans-serif; font-size: 25px;">What's your last name?</label>
							<input class="fs-anim-lower" id="q1" name="q1" type="text" placeholder="Last name" required/>
						</li>						
						<li>
							<label class="fs-field-label fs-anim-upper" for="q2" data-info="Just so people know" style="font-family:'Archivo', sans-serif; font-size: 25px;">What's your occupation as an entertainer?</label>
							<input class="fs-anim-lower" id="q2" name="q2" type="text" placeholder="What do you do as an entertainer?" required/>
						</li>
						<li data-input-trigger>
							<label class="fs-field-label fs-anim-upper" for="q3" data-info="This will help us know who you are" style="font-family:'Archivo', sans-serif; font-size: 25px;">Tell us about yourself.</label>
						...
						<li>
							<label class="fs-field-label fs-anim-upper" for="q4" style="font-family:'Archivo', sans-serif; font-size: 25px;">Describe your work/gigs</label>
