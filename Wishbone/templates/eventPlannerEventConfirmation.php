					...
					<div class="row">
						<div
							...
							<div class="title-01 title-01__style-04">
								<h2 class="title-01__title">SUCCESS :)</h2>
							</div>
							<p class="title2">
							Your request for an event has been successfully sent out.</p>
							<p class="title2"> Please wait for the entertainer to confirm availability and attendance.
							</p>
							<br/>
							<a href="eventPlannerEventList.php"><button type="button" class="btn-all"">Go To Events</button></a>
