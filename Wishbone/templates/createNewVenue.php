...
if (! empty($_POST)) {
    ...
    $sql = "INSERT INTO venues(venueOwnerId, venueName, venueCity, venueState, venueProvince) 
VALUES( $venueOwnerId, '$venueName','$venueCity','$venueState','$venueProvince')";
				...
				<div class="container">
					<div class="row">
						<div
							...
							<form action="createNewVenue.php" method="POST">
