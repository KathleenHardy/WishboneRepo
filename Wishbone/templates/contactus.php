					...
					<div class="row">
						<div
							...
							<div class="title-01 title-01__style-04">
								<h6 class="title-01__subTitle">contact</h6>
								<h2 class="title-01__title">TELEPHONE</h2>
								<div class="title2" style="text-align:center;" >6139823488</div>
							</div>
							<div class="title-01 title-01__style-04">
								<h2 class="title-01__title">EMAIL</h2>
								<div class="title2" style="text-align:center;" >wishbone@corporate.ca</div>
							</div>
							<div class="title-01 title-01__style-04">
								<h2 class="title-01__title">LOCATION</h2>
								<div class="title2" style="text-align:center;" >Ottawa, Ontario</div>
							</div>
						</div>
					</div>
				</div>
