...
<div class="row">
  <div class="card text-center">
    ...
    <div class="card-body">
      <h5 class="card-title title2">Availability Time</h5>
      <p class="card-text">Available From ____ to _____</p>
 ...
 <div class="button-lone">
                                      	<a
					href="addEntertainerAvailability-New.php"><button type="button"
