					...
					<div class="row">
						<div
							...
							<div class="title-01 title-01__style-04">
								<h1 class="main-title">Update Your Information</h1>
							</div>
							<form action="eventPlannerProfileUpdate.php" method="POST">
										<div class="form-group"> <!-- Event Name -->
    											...
    											<input type="text" class="form-control" style="border-bottom: 2px solid #faa828;" id="firstName" name="firstName" value="<?php echo $login_user_firstname;?>">
    									</div>	
    									<div class="form-group"> <!-- Event Name -->
    											<label for="lastName" class="control-label title2">Last Name</label>
    											<input type="text" class="form-control" style="border-bottom: 2px solid #faa828;" id="lastName" name="lastName" value="<?php echo $login_user_lastname;?>">
    									</div>	
    									
										<div class="form-group"> <!-- About Me -->
											<label for="aboutMe" class="title2">About Me</label>
											<textarea class="form-control" style="border: 2px solid #faa828;" rows="5" id="aboutMe" name="aboutMe"><?php echo $login_user_aboutme;?></textarea>
										</div>
										...
										<a href="entertainerMainPortfolio.php"><button class="btn-all" type ="button" style="display:inline;">Cancel</button></a>
