...
<div class="row">
  <div class="card text-center">
	...
	<button type="button" style="display:inline;"><a href="eventPlannerEntertainerView.php">View More</a></button>
	<button type="button" style="display:inline;"><a href="eventPlannerBookEvent.php">Book Now</a></button>
    </div>
  </div>
  <div class="card text-center">
    <img class="card-img-top event-img-size" src="../assets/img/backgrounds/1.jpg" alt="event img">
