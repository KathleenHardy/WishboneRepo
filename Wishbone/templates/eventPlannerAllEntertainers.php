...
<?php 
                        ...
                        <button type="button" style="display:inline;"><a href="eventPlannerEntertainerView.php?id='.$entertainer->getEntID().'">View More</a></button>
                        <button type="button" style="display:inline;"><a href="eventPlannerBookEvent.php?id='.$entertainer->getEntID().'">Book Now</a></button>
                        </div>
                      </div>';
