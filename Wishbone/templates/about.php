					...
					<div class="row">
						<div
							...
							<div class="title-01 title-01__style-04">
								...
								<h2 class="title-01__title">We Are The Leaders In This
									Industry</h2>
					...
					<div class="row">
							...
							<div class="iconbox iconbox__style-03">
								...
								<div>
									<h2 class="iconbox__title">
										<a href="#">The Myth of Ugly Design</a>
									</h2>
									<div class="iconbox__description">Duis porttitor libero
										ac egestas euismod. Maecenas quis felis turpis. Nulla quis
										turpis sed augue eg</div>
								</div>
							</div>
							<!-- End / iconbox -->
						...
						<div class="col-md-6 col-lg-3 ">
							...
							<div class="iconbox iconbox__style-03">
								...
								<div>
									...
									<div class="iconbox__description">Sed ante nisl,
										fermentum et facilisis in, maximus sed ipsum. Cras hendrerit
										feugiat eros, ut fringil</div>
								</div>
							</div>
							<!-- End / iconbox -->
						...
						<div class="col-md-6 col-lg-3 ">
							...
							<div class="iconbox iconbox__style-03">
								...
								<div>
									<h2 class="iconbox__title">
										<a href="#">How to Master Microcopy</a>
									</h2>
									<div class="iconbox__description">Nam elit ligula,
										egestas et ornare non, viverra eu justo. Aliquam ornare lectus
										ut pharetra dictum.</div>
								</div>
							</div>
							<!-- End / iconbox -->
					...
					<div class="consult-slide">
						...
						<div class="carousel__element owl-carousel"
							...
							<div class="textbox textbox__style-02">
								...
								<div class="textbox__body">
									<h2 class="textbox__title">
										<a href="#">Ashley Mills</a>
									</h2>
									<div class="textbox__description">Nam elit ligula,
										egestas et ornare non, viverra eu justo. Aliquam ornare lectus
										ut pharetra dictum.</div>
									...
									<div class="social-01">
										<nav class="social-01__navSocial">
											<a class="social-01__item" href="#"><i
												class="fa fa-facebook"></i></a><a class="social-01__item"
												href="#"><i class="fa fa-skype"></i></a><a
												class="social-01__item" href="#"><i
												class="fa fa-twitter"></i></a><a class="social-01__item"
							...
							<div class="textbox textbox__style-02">
								...
								<div class="textbox__body">
									<h2 class="textbox__title">
										<a href="#">Bruce Powell</a>
									</h2>
									<div class="textbox__description">Etiam non varius justo,
										vel tempor mi. Nulla facilisi. Fusce at tortor arcu.
										Suspendisse maximus ac</div>
							...
							<div class="textbox textbox__style-02">
								...
								<div class="textbox__body">
									...
									<div class="textbox__description">Sed ante nisl,
										fermentum et facilisis in, maximus sed ipsum. Cras hendrerit
										feugiat eros, ut fringil</div>
							...
							<div class="textbox textbox__style-02">
								<div class="textbox__image">
									<a href="#"><img src="../assets/img/avatars/4.jpg" alt="" /></a>
								</div>
								<div class="textbox__body">
									<h2 class="textbox__title">
										<a href="#">Cynthia Aguilar</a>
									</h2>
									<div class="textbox__description">Integer placerat
					...
					<div class="row">
							...
							<div class="post-02 post-02__style-02 js-post-effect">
								...
								<div class="post-02__body">
									...
									<div class="post-02__content">
										<div class="post-02__description">Etiam non varius
						...
						<div class="col-sm-6 col-md-6 col-lg-6 col-xl-3 "
							...
							<div class="post-02 post-02__style-02 js-post-effect">
								...
								<div class="post-02__body">
									<h2 class="post-02__title">
										<a href="#">Is UX Really That Important?</a>
									</h2>
									<div class="post-02__department">Business Consulting</div>
									<div class="post-02__content">
										<div class="post-02__description">Nam elit ligula,
											egestas et ornare non, viverra eu justo. Aliquam ornare
											lectus ut pharetra dictum. Aliquam erat volutpat. In
											fringilla erat at eros pharetra faucibus. Nunc a magna eu
											lectus fringilla</div>
										<a class="post-02__link" href="#">View detail</a>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6 col-md-6 col-lg-6 col-xl-3 "
							...
							<div class="post-02 post-02__style-02 js-post-effect">
								...
								<div class="post-02__body">
									...
									<div class="post-02__department">Business Consulting</div>
									<div class="post-02__content">
										<div class="post-02__description">Suspendisse ac elit
											vitae est lacinia interdum eu sit amet mauris. Phasellus
											aliquam nisi sit amet libero mattis ornare. In varius nunc
											vel suscipit rhoncus. Nunc hendrerit nisl nec orci eleifend
											accu</div>
										<a class="post-02__link" href="#">View detail</a>
									</div>
								</div>
